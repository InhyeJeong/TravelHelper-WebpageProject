...
<form:form commandName="review" enctype="multipart/form-data">
	...
	<div class="row">
		...
		<div class="col-md-10">
			<c:forEach var="file" items="${review.getImages}">
				<div>
	...
	<div class="text-center mt-3">
		...
		<a href="../view/${review.reviewId}?page=${param.page}" class="btn btn-unique btn-md">
